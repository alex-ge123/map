...
CREATE TABLE `map_element`  (
  ...
  `custom_element_width` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '自定义素材宽度',
  `custom_element_height` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '自定义素材高度',
